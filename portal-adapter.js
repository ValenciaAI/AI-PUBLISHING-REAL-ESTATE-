(() => {
"use strict";
const STORAGE_KEY="estate-ops.transport.v1";
const wait=ms=>new Promise(resolve=>setTimeout(resolve,ms));
class PortalAdapter extends EventTarget{
 constructor(options={}){
...
window.PortalAdapter=PortalAdapter;window.portalLink=new PortalAdapter({mode:"mock"});
})();
