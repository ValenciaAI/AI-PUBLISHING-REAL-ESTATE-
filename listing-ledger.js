(() => {
"use strict";
const STORAGE_KEY="estate-ops.ledger.v1";
class ListingLedger extends EventTarget{
 constructor(){
 ...
 recordApproval(decision,operator="human"){
  return this.enqueue(()=>this.append("approval."+decision,{decision,operator,artifactId:(this.latest("listing-pack")||{}).artifactId}));
 }
 verify(){
  return this.enqueue(async()=>{
...
window.ListingLedger=ListingLedger;window.listingLedger=new ListingLedger();
})();
